      ...
      {selectedIndex === -1 && (
        <div>
          <div className="hidden md:block bg-[url('/bg.png')] bg-cover bg-center">
            <div className="relative w-[1512px] mx-auto h-[510px] flex flex-col items-center md:bg-cover bg-no-repeat">
              ...
              <div className="hidden md:flex max-w-[1512px] flex-col md:flex-row items-center w-full pl-8">
                <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
                  <h1 className="w-max text-5xl md:text-6xl font-medium leading-[1.2] md:leading-[1.1] tracking-[-1.2px] font-poppins text-white">
                    Stay Protected with Adult <br /> Vaccinations
                  </h1>
                ...
                <div className="w-full md:w-1/2 px-4">
                  <ol className="list-decimal pl-5 text-[#2A2A2A] text-base  text-[16px] leading-[24px]">
                    <li className="mb-3">
                      ...
                      <br />
                      Vaccines help protect against severe illnesses, some of
                    ...
                    <li>
                      ...
                      crucial protection, particularly for older adults,
                      individuals with chronic illnesses, or those with weakened
                      immune systems.
                    </li>
                    <li>
                      <span className="text-[#2A2A2A] text-[16px] font-semibold leading-[24px]">
          ...
          <section className="container mx-auto">
            <div className="text-center my-8">
              ...
              <p className="text-center text-[#525252] text-[16px] font-normal leading-[24px]">
                ...
                safety, convenience, and <br /> professional care.
              </p>
              ...
              <p className="text-center text-[#525252] text-[16px] font-normal leading-[24px]">
                ...
                solutions for seniors, gender specific, and individuals with
                unique health needs, all delivered with Apollo&apos;s <br />{" "}
                trusted care.
              </p>
            </div>
            ...
            <div className="text-center">
              <h2 className="text-[#031432] text-center  text-[16px] font-semibold leading-normal">
                Below are some of the adult vaccines and immunizations that can
                be administered right at your home:
              </h2>
            ...
            <div className="container mx-auto">
              <div className="mt-8 mb-8">
                ...
                <p className="text-center text-[#525252] text-[16px] font-normal leading-[24px] max-w-3xl mx-auto mt-4">
                  ...
                  high-risk groups.
                  <br /> Expert administration by trained healthcare
                  professionals following strict safety protocols.
                  <br /> Customized vaccination plans based on your specific
                  needs.
                  <br /> Post vaccination follow-up and support to ensure your
                  well-being.
                  <br /> With Apollo&apos;s trusted expertise, protecting your
                  health has never been easier or more reliable.
                </p>
              </div>
            </div>
          </section>
