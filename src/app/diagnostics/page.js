          ...
          <section className="py-10 container mx-auto">
            <div className="text-center my-8">
              <p className="text-center text-[#525252] text-[16px] font-normal leading-[24px]">
                ...
                to your unique health requirements and preferences.
                <br />
                <br />A few of the Apollo Home Visit categories include-
                Doctors, Physiotherapist, Nurse, Respiratory Therapist, Speech
                Therapist and Dietitian at home
              </p>
            </div>
