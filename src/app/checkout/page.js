      ...
      <div className="flex flex-col space-y-6 w-[988px]">
        <div className="bg-white p-6">
          ...
          <p className="text-sm text-gray-500 mt-2">
            Select to whom you want to send your order or to whom you are buying
            subscriptions.
          </p>
          <div className="flex items-center space-x-6 mt-6">
            {users.map((user, index) => (
              <div key={index} className="flex flex-col items-center">
                ...
                <span className="text-sm text-gray-700 mt-2">{user.name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <svg
          ...
          fill="none"
        >
          <path d="M1 1L989 0.999914" stroke="#C0C0C0" strokeLinecap="round" />
        </svg>

        <div className="bg-white p-6">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-bold text-gray-800">Address</h2>
            <button className="text-teal-600 text-sm mt-6">Add Address</button>
          </div>
          <p className="text-sm text-gray-500 mt-2">
            Select where you want to send your purchased item. Note: exceptions
            can be there.
          </p>
