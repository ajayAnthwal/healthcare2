      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-10 container mx-auto">
        {cardData.map((card) => (
          ...
          >
            ...
            <button
  className="bg-gradient-to-r from-[#1AE2E9] via-[#019196] to-[#03676A] text-white px-7 py-3 rounded-full shadow-lg mt-6 hover:shadow-xl transition duration-300 flex items-center justify-center"
>
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none" className="mr-2">
    <path
