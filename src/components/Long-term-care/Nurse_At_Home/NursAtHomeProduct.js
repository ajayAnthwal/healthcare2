...
import product from "@/assets/images/longterm/product.png";
import chair from "@/assets/images/book/chair.png";
import Link from "next/link";

const NursAtHomeProduct = () => {
          ...
          {!isRentMode ? (
            <>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-right text-[14px] text-[#009A9F]  font-normal leading-[21px] ">
...
export default NursAtHomeProduct;
