...
const FloatingContactWidget = () => {
  ...
  return (
    <div className="fixed bottom-10 right-10 z-50 flex items-center space-x-4 widget-1">
      <button
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute right-0 bottom-16 flex flex-col items-end p-4 space-y-3">
            <button
